  ...
  return (
    <main className="flex flex-col mb-8 gap-5 ">
      ...
      >
        ...
        <p className="text-secondary dark:text-secondary_dark sm:max-w-[60%] max-sm:text-center">
          ...
          JavaScript. Sou pró-ativo, colaborativo e estou ansioso para enfrentar
